    ...
    <div class="admin_bloc d-flex flex-column align-items-center justify-content-center">
        ...
        <div class="bg_black p-5 m-5">
            ...
            <div class="d-flex flex-column justify-content-center align-items-center mb-5">
                <h3 class="align-self-start">MODIFIER UN PLAT</h3>
                <a href="admin-menu" class="admin_button align-self-end btn btn-primary rounded-0 mb-5">RETOUR</a>
            </div>

            <form action="admin-menu-modification-soumettre" method="post">

                <input type="hidden" name="id" value="<?= $dish["id"] ?>">

                <div class="d-flex justify-content-between mb-3">
                    <div class="form_title mb-3 d-flex flex-wrap">
                        <label class="mb-2" for="title">TITRE DE L'ENTRÉE</label>
                        <input type="text" name="title" class="form-control rounded-0 px-3" id="title" value="<?= $dish["title"] ?>">
                    </div>
                    ...
                    <div class="form_price mb-3 d-flex flex-column">
                        ...
                        <input type="number" step="0.01" min="0" name="price" id="price" class="input_price rounded-0 px-3" value="<?= $dish["price"] ?>">
                    </div>
                </div>

                <div class="mb-5">
                    <label class="mb-2" for="description">DESCRIPTION</label>
                    <textarea type="text" name="description" class="form-control rounded-0 px-3" id="description" rows="2"><?= $dish["description"] ?></textarea>
                </div>
